...
var (
	foundationFileServiceServiceInfo = NewServiceInfo()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return foundationFileServiceServiceInfo
}
...
func newServiceInfo() *kitex.ServiceInfo {
	serviceName := "FoundationFileService"
	handlerType := (*apis.FoundationFileService)(nil)
