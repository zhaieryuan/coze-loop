...
func (p *kOpenAPIServiceClient) ListPreSpanOApi(ctx context.Context, req *openapi.ListPreSpanOApiRequest, callOptions ...callopt.Option) (r *openapi.ListPreSpanOApiResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
