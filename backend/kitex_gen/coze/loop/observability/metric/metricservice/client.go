...
func (p *kMetricServiceClient) TraverseMetrics(ctx context.Context, req *metric.TraverseMetricsRequest, callOptions ...callopt.Option) (r *metric.TraverseMetricsResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
