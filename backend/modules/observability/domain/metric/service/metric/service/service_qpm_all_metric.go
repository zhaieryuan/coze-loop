...
func (m *ServiceQPMAllMetric) GetMetrics() []entity.IMetricDefinition {
...
func (m *ServiceQPMAllMetric) Operator() entity.MetricOperator {
	return entity.MetricOperatorDivide
}

func (m *ServiceQPMAllMetric) OExpression() *entity.OExpression {
