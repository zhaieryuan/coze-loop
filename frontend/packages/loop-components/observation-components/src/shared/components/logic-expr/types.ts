...
interface Props<L, O, R> {
  enableNot?: boolean;
  readonly?: boolean;
  leftRender?: (props: LeftRenderProps<L, O, R>) => React.ReactNode;
  operatorRender?:
    | ((props: OperatorRenderProps<L, O, R>) => React.ReactNode)
    | OperatorOption[];
  rightRender?: (props: RightRenderProps<L, O, R>) => React.ReactNode;
  errorMsgRender?: (props: RightRenderProps<L, O, R>) => React.ReactNode;
